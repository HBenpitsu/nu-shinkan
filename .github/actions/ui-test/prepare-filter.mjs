...
const installArgs = uiTestPackages.map((pkg) => `--filter=${pkg}...`);
const hasTests = uiTestPackages.length > 0;

if (!hasTests) {
  console.log("No packages with a ui_test script matched the filter.");
}
